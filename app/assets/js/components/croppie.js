...
(function (root, factory) {
    ...
    function _up() {
        var self = this;
        var step =  this.options.hasOwnProperty('step') ? this.options.step : 0.025;
        var targetZoom = self._currentZoom + step;;
        if (targetZoom > 5) {
            targetZoom = self._currentZoom;
        }
        _onButtonClick(self, targetZoom);
    }
    ...
    function _onButtonClick(self, targetZoom) {
        _onZoom.call(self, {
            value: parseFloat(targetZoom),
